...
import { ArrowLeft, Building2, PlusCircle, Loader2, Search, X, Edit2, Image as ImageIcon, ImagePlus, Filter, Map, FileText, ChevronDown, Check, Workflow } from 'lucide-react';
    ...
    <div className="flex flex-col bg-stone-50 relative h-full text-[13px]">
      <header className="h-16 flex items-center px-6 bg-white z-30 justify-between shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/ec" className="flex items-center gap-2 px-5 py-2 bg-white border border-stone-200 text-stone-700 rounded-xl font-medium hover:bg-stone-50 hover:border-stone-300 transition-colors whitespace-nowrap">
            <Workflow size={16} /> EC Pipeline
          </Link>
